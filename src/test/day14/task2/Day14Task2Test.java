...
public class Day14Task2Test {
    ...
    public void testing2() {
        ...
        Day14Task2 t = new Day14Task2(Arrays.asList(in));
    }

    @Test
    public void testing3() {
        String[] in = new String[] { "157 ORE => 5 NZVS", "165 ORE => 6 DCFZ",
    ...
    public void testing4() {
        String[] in = new String[] { "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG",
    ...
    public void testing5() {
        String[] in = new String[] { "171 ORE => 8 CNZTR",
                ...
                "189 ORE => 9 KTJDG", "1 MZWV, 17 XDBXC, 3 XCVML => 2 XMNCP",
